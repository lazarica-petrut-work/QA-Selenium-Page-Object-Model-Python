class Admin_Page_Locators_Class():
    ...
    employment_status_button_linktext = "Employment Status"
    ...
    licenses_button_linktext = "Licenses"
    languages_button_linktext = "Languages"
    memberships_button_linktext = "Memberships"

    # Nationalities
    nationalities_button_linktext = "Nationalities"
    ...
    localization_button_linktext = "Localization"
    language_packages_button_linktext = "Language Packages"
    modules_button_linktext = "Modules"
    social_media_authentication_button_linktext = "Social Media Authentication"
    register_oauth_client_button_linktext = "Register OAuth Client"
    ldap_configuration_button_linktext = "LDAP Configuration"
